    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          // รูปถ่ายงานซ่อม (intake/closure) จาก Firebase Storage — ไม่มีจุดไหนในแอปที่อัปโหลดทับ
          // path เดิมของรูปที่เคยมีอยู่แล้ว (รูปตอนปิดงานที่ปิดซ้ำหลังกด "ยกเลิกปิดงาน/ส่งมอบ" ก็
          // ตั้งใจใส่ timestamp ต่อ path ให้เป็นไฟล์ใหม่เสมอ ดู RepairClose.jsx — กันไม่ให้ URL ซ้ำ
          // เดิมจนโดน cache นี้เสิร์ฟรูปเก่าแทนรูปใหม่) URL ของแต่ละรูปจึงคงที่ตลอดไปจริง ใช้
          // CacheFirst ได้เต็มที่ — เปิดดูครั้งแรกค่อยโหลดจากเน็ต ครั้งต่อไป (รวมถึงตอนออฟไลน์)
          // ใช้จากเครื่องเลยไม่ยิงเน็ตซ้ำ
          {
